const Privacy = (props) => {
    return (
        ...
        <div style={{display:'flex', width:'100%', minHeight:'90vh', justifyContent:'center', fontSize:'0.7rem'}}>
            ...
            <h1>개인정보취급정책</h1>
            <p>엑스아이피는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법령을 준수하고 있습니다.</p>
            ...
            <p>- 회원가입시 : 이름 , 이메일 , 비밀번호, 이용약관동의, 개인정보보호</p>
            ...
            <p> 회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 oo년간 회원의 정보를 보유할 수 있습니다.</p>
